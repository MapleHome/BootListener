package com.maple.bootlistener.utils;

import android.annotation.SuppressLint;
import android.content.Context;
import android.content.SharedPreferences;

import com.maple.bootlistener.ListenerApp;
...
public final class SPUtils {
    ...
    public SPUtils() {
        sp = ListenerApp.getApp().getSharedPreferences("prefer.xml", Context.MODE_PRIVATE);
    }
